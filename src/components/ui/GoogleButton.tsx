...
export default function GoogleButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={loading}
      className="w-full py-3 rounded-xl text-sm font-semibold flex items-center justify-center gap-2.5 disabled:opacity-50 transition-opacity"
      style={{ background: '#fff', border: '1px solid var(--bdr2)', color: '#1f1f1f' }}
    >
